...
@section('title')
    Matriks Keputusan Ternomalisasi Terbobot| MAWAPRES
@endsection
@section('content')
<br>
...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Matriks Keputusan Ternomalisasi Terbobot</b></h4>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#table-mahasiswa").DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('admin.topsis.terbobot') !!}',
                    order:[0,'desc'],
                    columns:[
                        {data:'id', name: 'id'},
                        {data:'nim',name :'nim'},
                        ...
                        {data:'v_bahasa_inggris',name:'v_bahasa_inggris'},
